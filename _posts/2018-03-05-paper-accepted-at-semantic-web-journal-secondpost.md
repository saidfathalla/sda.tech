...
date:   2018-03-05 13:07:37 +0100
categories: paper accepted
author: Gezim Sejdiu
---
![SWJ](http://www.semantic-web-journal.net/sites/default/files/blogbuzz_logo.png){:class="img-responsive"} [Test second post] We are very pleased to announce that our group got a paper accepted at [Semantic Web Journal](http://www.semantic-web-journal.net/) on the Benchmarking Linked Data 2017 issue.
<!--more-->
